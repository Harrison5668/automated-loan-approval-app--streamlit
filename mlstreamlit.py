...
# Rename dataset columns for display
...
if st.button("Predict Loan Decision"):
    ...
    try:
        ...
        # Create SHAP Bar Chart with color mapping
        ...
        colors = ["#FF5733" if val > 0 else "#3498db" for val in feature_importance["SHAP Value"]]  # Warm for positive, Cool for negative
